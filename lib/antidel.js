...
/**
 * Saves a message to the message store and cleans old messages.
 */
 ...
 *
 * This function listens for incoming messages and stores them if they are not sent by the bot. It also listens for message updates to detect deletions. When a message is deleted, it retrieves the original message from storage and sends a notification to the chat, including the original content and sender information. Various message types are handled, including text, images, videos, audio, stickers, and documents.
 *
